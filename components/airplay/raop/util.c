...
#else
	// Ported 2026-05-27 from the legacy tcpip_adapter API to esp_netif
	// (the former was removed in IDF 5.x). Try STA first; fall back to
	// AP if STA isn't up.
