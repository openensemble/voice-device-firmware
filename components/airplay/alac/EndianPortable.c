...
// OE 2026-05-27: Xtensa (ESP32-S3) wasn't in the original arch list, so
// Swap32BtoN was returning input unchanged — frameLength=352 read as
// 0x60010000 (~1.6 billion) which then blew up calloc inside
// ALACDecoder::Init. GCC built-in macro is the catch-all.
#define TARGET_RT_LITTLE_ENDIAN 1
#endif
